...
const PrimeProduct = () => {
  ...
  if (!prime.length) return null;
    return (
       <section className="w-full max-w-screen-xl mx-auto px-4 md:px-6 py-12">
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        {prime.map((p) => (
    <article className="bg-base-100 border rounded-2xl shadow-sm hover:shadow-md transition p-4 flex flex-col h-full">
  {/* Image */}
  ...
  <div className="flex-1 flex flex-col">
    {/* Title + description centered, with reserved height for alignment */}
    ...
    <div className="mt-2 flex items-center justify-center gap-3">
      <span className="text-sm opacity-80">Min Qty: {p.minimum_selling_quantity}</span>
